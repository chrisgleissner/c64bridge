...
const KNOWLEDGE_BUNDLES: readonly KnowledgeBundle[] = [
  ...
  tools: ["read", "write", "verify_and_write_memory"],
      ...
      {
        uri: RESOURCE_URIS.basic.romRoutines,
        name: "BASIC ROM Routines Memory Map",
        description: "Memory-map-style breakdown of BASIC ROM routines, tables, parser helpers, and entry points.",
        relativePath: "data/basic/rom-routines.md",
        priority: "reference",
        summary: "Maps BASIC ROM landmarks, reusable interpreter routines, numeric helpers, string helpers, and C64-specific BASIC continuation entries.",
        prompts: ["memory-debug", "assembly-program", "basic-program"],
        ...
        tags: ["memory", "basic", "rom"],
      },
      {
        uri: RESOURCE_URIS.kernal.romRoutines,
        name: "KERNAL ROM Routines Memory Map",
        description: "Memory-map-style breakdown of KERNAL ROM routines, vectors, tables, and entry points.",
        relativePath: "data/kernal/rom-routines.md",
        priority: "reference",
        summary: "Maps KERNAL ROM vectors, jump table entries, internal routines, serial/tape/screen services, and reset handlers.",
        prompts: ["memory-debug", "assembly-program"],
  tools: ["read", "verify_and_write_memory"],
        relatedResources: [
          RESOURCE_URIS.memory.map,
